...
export const REACTION_SHAPES = {
  ...
  gold: {
    happy:  <svg viewBox="0 0 24 24"><polygon points="12,2 14.5,9 22,9 16,14 18.5,21 12,17 5.5,21 8,14 2,9 9.5,9" fill="currentColor" opacity="0.18"/><polygon points="12,2 14.5,9 22,9 16,14 18.5,21 12,17 5.5,21 8,14 2,9 9.5,9" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/><path d="M9 13s1.2 1.5 3 1.5 3-1.5 3-1.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/><circle cx="10" cy="10.5" r="0.8" fill="currentColor"/><circle cx="14" cy="10.5" r="0.8" fill="currentColor"/></svg>,
