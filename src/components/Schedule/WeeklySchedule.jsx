...
const VISITOR_ICONS = {
  ...
  sea:      <svg viewBox="0 0 20 20" width="16" height="16"><defs><linearGradient id="oceanGrad" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" style={{stopColor: 'currentColor', stopOpacity: 0.8}} /><stop offset="100%" style={{stopColor: 'currentColor', stopOpacity: 1}} /></linearGradient></defs><path d="M0 8Q5 5 10 8T20 8" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" opacity="0.6"/><path d="M0 11Q5 8 10 11T20 11" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" opacity="0.75"/><path d="M0 14Q5 11 10 14T20 14" fill="currentColor" opacity="0.85"/><path d="M0 17L20 17L20 20L0 20Z" fill="currentColor" opacity="0.9"/></svg>,
